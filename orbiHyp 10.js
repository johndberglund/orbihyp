...
function sheet() {
  ...
  // 3 sides. 7,2,3 works. 8,3,2 works. 7,3,2 works.
  // 3.5,3,3 works. 4,3,3 works
  funDom = solve3Ang(Math.PI/4,Math.PI/3,Math.PI/4);

  // 4 sides. 0.65,2,3 works. 0.8,5,3 works. 
//  funDom = solve2Ang(0.8,Math.PI/5,Math.PI/3);

  // 5 sides. 1,1,3 works
//  funDom = solve1Ang(1,1,Math.PI/2);

  // 6 sides. 1.2,1.2,1.2 works
//  funDom = solve0Ang(1.2,2,1.2);
...
/*
  ...
  let angle2 = Math.PI/7;
  funDom = solve3Ang(angle1*2,angle2/2,angle2/2);
  genMats = [];

  let myLine = points2Line(funDom[1],funDom[2]);
  let myMat = hReflMat(myLine);
  genMats.push(myMat);
...
/*
  ...
  genMats = [];
  let myLine = points2Line(funDom[2],funDom[3]);
  let myMat = hReflMat(myLine);
  genMats.push(myMat);
...
/*
  ...
  genMats = [];
  let myLine = points2Line(funDom[0],funDom[1]);
  let myMat = hReflMat(myLine);
  genMats.push(myMat);
...
/*
  // 3 sides. 
  let angle1 = Math.PI/6;
  let angle2 = Math.PI/4;
  let angle3 = Math.PI/3;
  let shape1 = solve3Ang(angle1,angle2,angle3);
  let shape2 = solve3Ang(angle1,angle3,angle2);
  let myMat = isomSeg2Seg(shape2[0],shape2[2],shape1[0],shape1[1]);
...
/*
  // 4 sides. 0.65,2,3 works. 0.8,5,3 works. 
  let side1 = 0.8;
  let angle2 = Math.PI/5;
  let angle3 = Math.PI/3;
  shape1 = solve2Ang(side1,angle2,angle3);
  shape2 = solve2Ang(side1,angle3,angle2);
  let myMat = isomSeg2Seg(shape2[0],shape2[3],shape1[1],shape1[2]);
...
function orb3xx() {
  ...
  genMats.push(myMat);
  myMat = isomSeg2Seg(funDom[3],funDom[2],funDom[3],funDom[4]);
  genMats.push(myMat);
  myMat = isomSeg2Seg(funDom[0],funDom[7],funDom[6],funDom[7]);
